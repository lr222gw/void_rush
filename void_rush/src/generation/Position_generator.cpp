...
Platform* Position_generator::jumpPoint_generation_helper(Platform* start, Platform* end)
{
    ...
    if(!this->pl->isJumpPossible(*end->getPos())){
        ...
        t = jumpPoint_generation_helper(midd_platform, end);
    ...
    if(!this->pl->isJumpPossible(*midd_platform->getPos())){
        ...
        t2 = jumpPoint_generation_helper(start, midd_platform);
    }else{
