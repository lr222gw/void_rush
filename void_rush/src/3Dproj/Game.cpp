...
void Game::setUpUI()
{
	...
	UI->createUIString("Write your name and", vec2(-0.9f, 0.3f), vec2(0.08f, 0.08f), "NameDesc");
	UI->createUIString("press Enter to submit!", vec2(-0.9f, 0.15f), vec2(0.08f, 0.08f), "NameDesc2");
